...
CSRF_TRUSTED_ORIGINS = [
    'https://neverforgottenmemorials.ie',
    'https://www.neverforgottenmemorials.ie',
    'https://neverforgottentech-7593096aaa0b.herokuapp.com',
]
...
SOCIALACCOUNT_EMAIL_VERIFICATION = 'optional'  # CHANGED from 'none' to 'optional'
SOCIALACCOUNT_EMAIL_REQUIRED = True
SOCIALACCOUNT_QUERY_EMAIL = True
SOCIALACCOUNT_LOGIN_ON_GET = False  # CRITICAL: CHANGED from True to False
SOCIALACCOUNT_ADAPTER = 'neverforgotten.adapters.CustomSocialAccountAdapter'  # ADD THIS LINE
